...
//loại xe khi được thêm sẽ kiểm tra trường 'Names' trong localStorage xem có tồn tại tên của xe đó chưa ?
//Nếu tồn tại thì cập nhật trường 'TÊN LOẠI XE' local Storage tại quantity+=1
//Nếu chưa thì tạo ra 1 trường trong localStorage tên là Tên của loại xe đó, và lưu thông tin của xe trong phần value
//Sau đó cập nhật trường Names: thêm tên loại xe đó vào

function addCart(name, price, image) {
    var DottedPrice = Number(price).toLocaleString("vi");
    //Mỗi khi bấm thêm loại xe vào giỏ hàng sẽ có thông báo
...
//xóa key có tên xe đó và xóa tên xe đó khỏi key Names 
